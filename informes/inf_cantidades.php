			...
			<TR>
			  ...
			  <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#333333" id="select_tablas" >
				...
				$sql = " SELECT * FROM kardex	
					...
					WHERE kardex.cod_bod_kar=$codigo_bodega order by cant_ref_kar,nom_pro, cod_talla  ";
					$db->query($sql);
					$estilo="formsleo";
					while($db->next_row()){ 	
                ...
                <tr id="fila_0"  >
				  ...
				  <?php if($db->cant_ref_kar <= 5){ $clase = "celda_roja"; } else { $clase = "celda_verde"; }?>
				   <td class="<?php echo $clase;?>"><div align="right"><?=number_format($db->cant_ref_kar,0,".",".")?></div></td>
			    </tr>
