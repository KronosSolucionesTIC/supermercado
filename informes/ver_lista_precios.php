...
<TABLE width="100%" border="1"  cellspacing="1" bgcolor="#F2F2F2" class="tabla">
	<TR>	
...
?>
     <tr>
      <td align="center" colspan='5'><a href="../exportar/word/lista.php?codigo=<?=$codigo?>"><img src='../imagenes/word.png'></a><a href="../exportar/excel/lista.php?codigo=<?=$codigo?>"><img src='../imagenes/excel.png'></a><a href="../exportar/pdf/lista.php?codigo=<?=$codigo?>"><img src='../imagenes/pdf.png'></a></td>
    </tr>
    <tr>
      <td align="center" colspan='5'><input name="button" type="button" class="botones"  onClick="window.print()" value="Imprimir" /><input name="button2" type="button" class="botones"  onClick="window.close()" value="Cerrar" /></td>
    </tr>
</TABLE>
</FORM>